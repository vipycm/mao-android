...
import static com.vipycm.mao.camera.CameraRenderer.CUBE;
import static com.vipycm.mao.camera.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
public class CameraFilterGroup extends CameraFilter {
    ...
    protected List<CameraFilter> mFilters;
    protected List<CameraFilter> mMergedFilters;
    ...
    public CameraFilterGroup(List<CameraFilter> filters) {
        ...
        float[] flipTexture = TextureRotationUtil.getRotation(0, false, true);
    ...
    public void addFilter(CameraFilter aFilter) {
        if (aFilter == null) {
            return;
        }
    ...
    public List<CameraFilter> getMergedFilters() {
    ...
    public void updateMergedFilters() {
        ...
        for (CameraFilter filter : mFilters) {
            if (filter instanceof CameraFilterGroup) {
                ((CameraFilterGroup) filter).updateMergedFilters();
                filters = ((CameraFilterGroup) filter).getMergedFilters();
