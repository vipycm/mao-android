...
package com.vipycm.mao.billing;
...
public class IabHelper {
    ...
    public void buybuybuy(Activity act, String sku, String type, int requestCode, OnIabPurchaseFinishedListener listener) {
        try {
            if (ITEM_TYPE_INAPP.equals(type)) {
                launchPurchaseFlow(act, sku, requestCode, listener, "vipycm");
            } else if (ITEM_TYPE_SUBS.equals(type)) {
                launchSubscriptionPurchaseFlow(act, sku, requestCode, listener, "vipycm");
            } else {
                logError("buybuybuy type error:" + type);
            }
        } catch (IabAsyncInProgressException e) {
            e.printStackTrace();
        }
